...
if(isset($_POST['nom_entrp'])&&
   isset($_POST['nom_resp'])&&
   isset($_POST['email'])&&
   isset($_POST['tel'])&&
   isset($_POST['adresse'])&&
   isset($_POST['messag'])){
                $insertion=$newBD->prepare('INSERT INTO entreprises VALUES(NULL, :nom_entrp, :nom_resp, :email, :tel, :adresse, :messag);');
        $insertion->bindValue(':nom_entrp',$_POST['nom_entrp']);
        $insertion->bindValue(':nom_resp',$_POST['nom_resp']);
